...
namespace TS.GazeInteraction
{
    ...
    public class GazeInteractor : MonoBehaviour
    {
        ...
        TestGazeInteraction testGazeInteraction;
        ...
        private void Update()
        {
            ...
            if (Physics.Raycast(_ray, out _hit, _maxDetectionDistance, _layerMask))
            {
                ...
                var gazeMeshRenderer = _hit.collider.gameObject.GetComponent<MeshRenderer>();
                ...
                if (_interactable.IsActivable && !_interactable.IsActivated)
                {
                    ...
                    if (progress == 1)
                    {
                        ...
                        testGazeInteraction.ActivateGazedObject(gazeMeshRenderer, _hit);
